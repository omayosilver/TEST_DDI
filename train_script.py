...
parser.add_argument('--rel_total', type=int, default=1318, help='num of interaction types')
parser.add_argument('--lr', type=float, default=0.01, help='learning rate')
parser.add_argument('--n_epochs', type=int, default=1, help='num of epochs')
parser.add_argument('--kge_dim', type=int, default=64, help='dimension of interaction matrix')
parser.add_argument('--batch_size', type=int, default=200000, help='batch size')
...
###### Dataset
df_ddi_train = pd.read_csv('DATA_CSV\AdverseDrugDrugInteractionDataset_train.csv')
df_ddi_val = pd.read_csv('DATA_CSV\AdverseDrugDrugInteractionDataset_val.csv')
df_ddi_test = pd.read_csv('DATA_CSV\AdverseDrugDrugInteractionDataset_test.csv')

train_tup = [(h, t, r) for h, t, r in zip(df_ddi_train['drug1_id'], df_ddi_train['drug2_id'], df_ddi_train['drug_drug_interaction_id'])]
val_tup = [(h, t, r) for h, t, r in zip(df_ddi_val['drug1_id'], df_ddi_val['drug2_id'], df_ddi_val['drug_drug_interaction_id'])]
test_tup = [(h, t, r) for h, t, r in zip(df_ddi_test['drug1_id'], df_ddi_test['drug2_id'], df_ddi_test['drug_drug_interaction_id'])]
